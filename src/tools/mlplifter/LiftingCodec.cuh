...
namespace Flair
{
	...
	private:
		...
		__host__ void GenerateTrainingSet(Image1f& inputImage, const int basisU, const int basisV, const int seed, InputSampleList& inputSamples, std::vector<float>& inputMeans, OutputSampleList& targetSamples) const;
